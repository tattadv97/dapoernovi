...
class Produk extends CI_Controller {
	...
	public function gambar($id_produk)
	{
		...
		// Masuk Database
			...
			$config['height']      	 	= 250; // Dalam ukuran pixel
			$config['thumb_marker']		= '';
			...
			$data = array(	'id_produk'		=>	$id_produk,
							...
							// Disimpan nama file upload_gambar
							'gambar'		=>	$upload_gambar['upload_data']['file_name'],
						);

			$this->produk_model->tambah_gambar($data);
			$this->session->set_flashdata('sukses', 'Data gambar telah berhasil ditambahkan');
	...
	public function tambah()
	{
		...
		// Masuk Database
			...
			$this->session->set_flashdata('sukses', 'Data telah berhasil ditambahkan');
